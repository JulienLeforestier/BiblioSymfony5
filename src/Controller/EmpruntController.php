...
class EmpruntController extends AbstractController
{
    ...
    #[Route('/list', name: 'emprunt_whitout_return', methods: ['GET'])]
    public function listWithoutReturn(EmpruntRepository $empruntRepository): Response
    {
        return $this->render('emprunt/index.html.twig', [
            'emprunts' => $empruntRepository->findByReturnDate()
        ]);
    }
